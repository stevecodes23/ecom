...
import { GetWishListResponse, WishListResponseDto, wishlistDto } from './dto/wishlist.dto';
...
@ApiResponse({ status: 201, description: 'The product has been successfully deleted.',type:WishListResponseDto})
...
@ApiResponse({ status: 201, description: 'list of all poducts in the wishlist',type:GetWishListResponse})
